#!/usr/bin/env ruby
#
# Patched version of the htmlproofer wrapper script that disables
# CA verification of https:// URLs
#
# Unfortunately the builtin htmlproofer script offers no facility
# to add general items to the configuration, so it's necessary to
# fork this script
