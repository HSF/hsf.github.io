...
HSF got invited to contribute to the session “Sustainability of the MC toolchain” with a 15 min presentation. Need to find speaker urgently since the session is precisely a week from today.
...
- Day update post meeting: Sapta agreed to prepare and deliver the talk. Thank you Sapta!

### EPPSU Paper

Status of submission to EPJ C: referee suggested addition of a glossary. TBD asap whether we add it or not.

ACTION: Graeme and Michel to reply back to the referee.

### Idea to create a bibtex repository

Indeed, one often needs to dig out the same references over and over again, be it for HSF workshop proceedings or some software related document/paper.
...
The HSF has no funding source but does have a little pot of money from what it receives from the GSoC programme that's been running for several years. This budget has been used to sponsor for example coffee/tea breaks at training events.
...
https://docs.google.com/presentation/d/1zrV0P_kIDxwDS9bZsYYE6S3HXPUsaEXfKkQUYr8EjmA/edit?slide=id.p#slide=id.p
