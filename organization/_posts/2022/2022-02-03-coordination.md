...
- ATLAS computing coordinators have expressed concern about the duplication of effort and meetings that could be implied by a new activiy area (they favour existing bodies)
...
- Liz supportive of this effort, it should be mindful of *reducing* duplication. Given the people volunteering to lead it have overlap with the HSF working group, that should happen.
- This would straddle software and facilities, going a bit beyond HSF traditional area
- Simone, can look at exosystem of tools and services, so it does cross boundaries; should have a strong link to GDB (liaison person); what's the overlap with the Analysis WG in forming the problem statement?
- Should WLCG be directly represented directly? 
- Alessandra was keen on the liaison position to take forward ideas that were being discussed already; the new activity seems a very useful place to help define the issues and involve everyone
- Andrea, we should think beyond "boundaries" of software v. computing and think software *and* computing; we do have too many meetings and want to avoid dispersion adn duplication
- Nicole, yes this does straddle groups, in the DAWG group we don't feel that we can provide this view and this activity would involve other people in a useful way
- Pere, facilities are very tangiable things (which cost money), Analysis WG can develop inputs that can go to the GDB, which aquires the resources - so where does this sit?
- Paul, DAWG did have one (corrected from "two") meeting with DOMA in the past - https://indico.cern.ch/event/890991/
    - We also had a meeting on "Computing Infrastructure for Analysis": https://indico.cern.ch/event/835581/
- Graeme - HSF is a *do-ocracy* and we have people who would like to *do*, so I think we should let this activity move forwrd and let it's proponents make is a success
- David - are there aspirations to become a WG? 
    - Mark, no, it should have a goal as an activity
- Okasana, want to provide useful input to other groups

**Meeting agreed to approve the formation of this group and, like all HSF activities, to look later to see if it is the optimal way to organise our efforts. We wish the proponents every success!**
...
Proposed dates are narrowed to 23-25 May at IJCLab in Orsay. Covid means f2f cannot be assured even then. Need to gadge community sentiment on this.

Second organisers meeting today at 17h. Aim to get an annoucement out very soon!
...
We can put back the HSF Actvity page in this case.
