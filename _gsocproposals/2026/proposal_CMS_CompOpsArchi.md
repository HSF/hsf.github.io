...
The goal of this GSoC project is to work on the development of autonomous agents to perform non-trivial computing operations at CMS, a task which integrates large language models with highly accurate retrieval, expert domain knowledge, heteregenous data sources, and agentic tools. The participant will get familiarity with state-of-the-art and in-demand agentic tools like LangChain and MCP.
