...
The curriculum is comprised of a set of *modules* (developed by HSF, Software Carpentries, and other organization), so that learners students can focus on what is most relevant to them.
