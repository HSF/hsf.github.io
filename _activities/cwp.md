...
We collect some of the most [recent talks](/cwp/cwp-papers-and-talks.html) on the CWP Roadmap that are
useful as an overview or in preparing other presentations. 
...
We keep some [snapshots](/cwp/cwp-papers-and-talks.html) of Working Group Papers that are useful
